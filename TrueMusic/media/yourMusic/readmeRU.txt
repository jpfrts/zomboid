1. Распакуйте архив yourMusic.rar или yourMusic.zip (сперва переименуйте файл "yourMusic.zi" в "yourMusic.zip") в ту же папку, где он находится.
ВНИМАНИЕ!!! Путь до exe-файла должен быть такой: True Music/media/yourMusic/AddYourMusicToTheMod.exe. В ином случае, при запуске выдаст ошибку.

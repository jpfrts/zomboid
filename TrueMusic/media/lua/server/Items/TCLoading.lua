-- Tsarcraft.TCWalkman
    ...
    table.insert(ProceduralDistributions["list"]["WardrobeManClassy"].junk.items, "Tsarcraft.TCWalkman");
    ...
    table.insert(ProceduralDistributions["list"]["WardrobeWoman"].junk.items, "Tsarcraft.TCWalkman");
    table.insert(ProceduralDistributions["list"]["WardrobeWoman"].junk.items, 0.5);
    
    table.insert(ProceduralDistributions["list"]["WardrobeWomanClassy"].junk.items, "Tsarcraft.TCWalkman");

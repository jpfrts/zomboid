...
ISServerSandboxOptionsUIover = ISPanelJoypad:derive("ISServerSandboxOptionsUIover")
...
function ISServerSandboxOptionsUIover:createChildren()
...
function ISServerSandboxOptionsUIover:createPanel(page)
	if page.customui then
...
function ISServerSandboxOptionsUIover:settingsToUI(options)
...
function ISServerSandboxOptionsUIover:onMouseDownListbox(item)
	if item.page then
...
function ISServerSandboxOptionsUIover:destroy()
	self:removeFromUIManager()
end

function ISServerSandboxOptionsUIover:onButtonApply()
	self:settingsFromUI(self.options)
	self.options:sendToServer()
	self:destroy()
end

function ISServerSandboxOptionsUIover:onButtonClose()
	self:destroy()
end

function ISServerSandboxOptionsUIover:new(x, y, width, height)
	local o = ISPanelJoypad:new(x, y, width, height)
	setmetatable(o, self)
	self.__index = self
	o.x = x
	...
	ISServerSandboxOptionsUIover.instance = o
	return o
end
